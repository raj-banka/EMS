...
interface NewTaskProps {
  ...
  return (
    <div className='flex-shrink-0 w-[350px] h-full bg-yellow-200 text-black rounded-2xl p-5'>
        ...
        <div className='flex items-center justify-between mt-8'>
            ...
            className='bg-green-500 text-sm py-1 px-2 border-none rounded cursor-pointer hover:bg-green-400'>Accept Task</button>
        </div>
      </div> 
  )
}
